...
public final class MarkupListTest {
    public static final Selector SELECTOR = new Selector(MarkupListTest.class)
            .variant("DocBookList", MarkupListTest.variant("DocBook", Map.ofEntries(
                    Map.entry("<p>", "<para>"), Map.entry("</p>", "</para>"),
                    Map.entry("<em>", "<emphasis>"), Map.entry("</em>", "</emphasis>"),
                    Map.entry("<strong>", "<emphasis role='bold'>"), Map.entry("</strong>", "</emphasis>"),
                    Map.entry("<s>", "<emphasis role='strikeout'>"), Map.entry("</s>", "</emphasis>"),
                    Map.entry("<ul>", "<itemizedlist>"), Map.entry("</ul>", "</itemizedlist>"),
                    Map.entry("<ol>", "<orderedlist>"), Map.entry("</ol>", "</orderedlist>"),
                    Map.entry("<li>", "<listitem>"), Map.entry("</li>", "</listitem>")
            )))
            ;
