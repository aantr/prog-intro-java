...
public class MarkupBase implements Element {
    ...
    public MarkupBase(List<Element> elements, String symbol) {
    ...
    public MarkupBase(List<Element> elements, String symbol, String tag) {
        this.elements = elements;
        this.markdownSymbol = symbol;
        this.tag = tag;
        this.role = null;
    ...
    public MarkupBase(List<Element> elements, String symbol, String tag, String role) {
        this.elements = elements;
        this.markdownSymbol = symbol;
        this.tag = tag;
        this.role = role;
